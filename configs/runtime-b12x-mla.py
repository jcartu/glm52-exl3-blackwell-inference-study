...
class B12xMLASparseImpl(MLAAttentionImpl[B12xMLASparseMetadata]):
    ...
    def dcp_project_before_merge_in_workspace(
        ...
        # The planned head-major output always uses the configured token
        # capacity as its pitch. A shorter final prefill chunk is therefore a
        # non-contiguous view of that allocation, regardless of whether virtual
        # TP head padding is needed. It is safe here because the projection
        # input is compacted below before entering cuBLAS.
